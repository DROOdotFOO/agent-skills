...
**Meta** (16): polymath, architect, agent-designer, adversarial-reviewer, self-improving-agent, codebase-onboarding, rag-architect, llm-cost-optimizer, digest, recall, autoresearch, watchdog, prepper, sentinel, patchbot, skill-creator
...
520 tests total across all agents, 0 mocks.
