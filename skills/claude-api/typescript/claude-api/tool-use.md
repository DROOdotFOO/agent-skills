---
title: Tool Use with Claude API in TypeScript
impact: CRITICAL
impactDescription: Core agent pattern for defining and executing tools with the TypeScript SDK.
tags: typescript, claude, api, tool-use, agents, function-calling
---
